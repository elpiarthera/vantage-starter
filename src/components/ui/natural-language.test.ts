...
describe("parseNaturalLanguage", () => {
	...
	describe("today", () => {
		...
		it("is case-insensitive", () => {
			expect(parseNaturalLanguage("Today")).toEqual(
	...
	describe("tomorrow", () => {
		...
		it("is case-insensitive", () => {
			expect(parseNaturalLanguage("Tomorrow")).toEqual(
	...
	describe("yesterday", () => {
		...
		it("is case-insensitive", () => {
			expect(parseNaturalLanguage("YESTERDAY")).toEqual(
	...
	describe("next week", () => {
		...
		it("is case-insensitive", () => {
			expect(parseNaturalLanguage("Next Week")).toEqual(
				new Date(2026, 1, 2, 0, 0, 0, 0),
			);
			expect(parseNaturalLanguage("NEXT WEEK")).toEqual(
				new Date(2026, 1, 2, 0, 0, 0, 0),
			);
