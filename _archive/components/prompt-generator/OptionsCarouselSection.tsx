												...
												<TooltipProvider>
													<Tooltip>
														<TooltipTrigger asChild>
															...
															>
																{/* biome-ignore lint/a11y/noStaticElementInteractions: Video preview on hover requires event handlers */}
																<div
																	role="presentation"
														...
														<TooltipContent>
															<p className="max-w-xs">{option.prompt}</p>
														</TooltipContent>
													</Tooltip>
												</TooltipProvider>
											</CarouselItem>
