/**
 * Design System Configuration — ported from shadcn/ui v4
 * Defines styles, themes, base colors, bases, radii, and fonts.
 * Default style: "luma"
 */
...
export const STYLES = [
	...
	{ name: "mira", title: "Mira", description: "Made for compact interfaces." },
...
// ============================================================================
// THEMES — Full OKLCH color definitions
// ============================================================================
...
export const THEMES: Theme[] = [
	...
	// Accent themes (partial overrides — merge on top of a base color)
	{
		name: "amber",
		title: "Amber",
		type: "registry:theme",
...
export type ChartColorName = string;

// ============================================================================
// BASE COLORS — Derived from THEMES (neutral base color tones)
// ============================================================================
...
export const BASE_COLORS = THEMES.filter((theme) =>
	BASE_COLOR_NAMES.includes(theme.name),
);
...
// ============================================================================
// FONT VALUES — Derived from FONTS in fonts.ts
// ============================================================================
...
// ============================================================================
// DESIGN SYSTEM CONFIG — Zod schema
// ============================================================================

export const designSystemConfigSchema = z.object({
	base: z.string().default("radix"),
	style: z.string().default("luma"),
	baseColor: z.string().default("neutral"),
	theme: z.string().default("neutral"),
	chartColor: z.string().default("neutral"),
	font: z.string().default("inter"),
	fontHeading: z.string().default("inherit"),
	item: z.string().optional(),
	rtl: z.boolean().default(false),
	menuAccent: z.string().default("subtle"),
	menuColor: z.string().default("default"),
	radius: z.string().default("default"),
});

export type DesignSystemConfig = z.infer<typeof designSystemConfigSchema>;

// Default config — Luma style as our standard
...
/**
 * Builds a registry theme from a design system config.
 * Merges base color + theme CSS vars, applies chart color and menu accent overrides.
 */
