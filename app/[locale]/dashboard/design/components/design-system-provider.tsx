/**
 * DesignSystemProvider — CSS variable injection provider
 * Ported from shadcn/ui v4. Injects CSS variables into the DOM via useLayoutEffect,
 * manages body classes, applies fonts, and handles menu theming.
 */
