...
function getToolLabel(
	...
	const readable = toolName.replace(/([A-Z])/g, " $1").toLowerCase().trim();
...
export function ToolCallIndicator({
	...
	const isActive = state === "streaming" || state === "call" || state === "partial-call";
	...
	return (
		<div
			...
			className={cn(
				...
				isActive && "bg-[oklch(0.62_0.16_44_/_0.12)] text-[oklch(0.52_0.16_44)]",
				isDone &&
