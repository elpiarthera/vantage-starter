...
// merged onto it via `useRender`'s `props` param. When not `asChild`,
// `defaultTagName` renders the plain host element. See
// docs/migration-base-ui.md §M9 and the identical helper in `button.tsx`.
	...
	(
		...
		const setOpen = React.useCallback(
			(value: boolean | ((value: boolean) => boolean)) => {
				...
				// biome-ignore lint/suspicious/noDocumentCookie: cookie-based sidebar state is intentional for SSR hydration
		...
		// biome-ignore lint/correctness/useExhaustiveDependencies: setOpenMobile is stable (useState setter) but biome cannot infer this
		...
		// biome-ignore lint/correctness/useExhaustiveDependencies: setOpenMobile is a stable useState setter but biome cannot infer this
...
>(
	(
		...
		const t = useTranslations("sidebar_ui");
