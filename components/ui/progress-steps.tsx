 ...
 * repo's OKLCH theme (`bg-foreground`, `text-background`, `border-foreground`,
 * `border-muted-foreground/40`, `bg-border`, `bg-card`), so no color
 * remapping was needed. The `data-apps-sdk-status` / `data-apps-sdk-surface`
 * attributes (which only had meaning paired with the un-adopted
 * `apps-sdk.css`) have been removed. Not yet wired to any surface
 * (net-new capability, later wave).
 */
"use client";
