 ...
 *
 * Shared type definitions for mcpcn components. Ported as-is (the
 * `shared-types` registry item) so category-specific types stay unified
 * across every ported block and never collide when more blocks are
 * installed in a later wave.
 */
