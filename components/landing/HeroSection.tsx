			...
			<div className="relative mx-auto max-w-6xl px-6">
				<div className="text-center">
					...
					<div className="flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-in-up opacity-0 stagger-4">
						<Button
							asChild
							className="group h-auto gap-2 rounded-xl bg-gray-900 dark:bg-gray-100 px-7 py-3.5 text-base font-bold text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-200 hover:shadow-lg active:scale-[0.98] btn-shadow focus-ring"
						>
